...
namespace HospitalSystem
{
    public partial class Dashboard : Form
    {
        ...
        {
            UserNameIDMenuLabel.Text = Username + " (" + DoctorID + ")";
        ...
        {
            new ViewAllPrescriptions().ShowDialog();
        }
        ...
        private void CheckOutButton_Click(object sender, EventArgs e)
        {
            ...
            if (_CashForm.ShowDialog() == DialogResult.OK)
            {
                ...
                if (_DataAccess.RecordASale(ProductsList, DateTime.Now, DoctorID, Convert.ToDecimal(_CashForm.CashGivenBox.Text), Convert.ToDecimal(_CashForm.TotalBillBox.Text), Convert.ToDecimal(_CashForm.CashReturnBox.Text)))
                {
