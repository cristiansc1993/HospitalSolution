...
namespace HospitalSystem.HospitalDBDataSetTableAdapters {
    ...
    public partial class UserRolesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserRoles] WHERE (([Id] = @Original_Id) AND ([RoleName] = @Ori" +
                "ginal_RoleName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserRoles] ([RoleName]) VALUES (@RoleName);\r\nSELECT Id, RoleNa" +
                "me FROM UserRoles WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[UserRoles] SET [RoleName] = @RoleName WHERE (([Id] = @Original_Id) " +
                "AND ([RoleName] = @Original_RoleName));\r\nSELECT Id, RoleName FROM UserRoles WHER" +
                "E (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HospitalSystem.Properties.Settings.Default.HospitalDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, RoleName FROM dbo.UserRoles";
        ...
        public virtual int Fill(HospitalDBDataSet.UserRolesDataTable dataTable) {
        ...
        public virtual HospitalDBDataSet.UserRolesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HospitalDBDataSet.UserRolesDataTable dataTable = new HospitalDBDataSet.UserRolesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalDBDataSet.UserRolesDataTable dataTable) {
